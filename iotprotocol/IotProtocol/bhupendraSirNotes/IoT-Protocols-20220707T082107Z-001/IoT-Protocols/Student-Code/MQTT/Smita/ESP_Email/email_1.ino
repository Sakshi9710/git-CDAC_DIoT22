...
const char* ssid = "DIR-615-6442";
const char* password = "NSB@2001";
const char* mqtt_server = "198.168.0.175";
#define led 2
...
#define emailRecipient        "smitanannor96@gmail.com"
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    String user = "DIR-615-6442";
    String pass = "NSB@2001";
    // Attempt to connect
