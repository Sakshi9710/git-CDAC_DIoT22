...
import { CoapPacket, CoapRequestParams, OptionValue } from 'coap/dist/models/models';
import RetrySend from 'coap/dist/lib/retry_send';
import { SegmentedTransmission } from 'coap/dist/lib/segmentation';
