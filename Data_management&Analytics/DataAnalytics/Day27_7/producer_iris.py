...
if __name__ == "__main__":
    ...
    for message in flower_list:
        ...
        message_fields_value_list.append(message["SepalLengthCm"])
        message_fields_value_list.append(message["SepalWidthCm"])
        message_fields_value_list.append(message["PetalLengthCm"])
        message_fields_value_list.append(message["PetalWidthCm"])
